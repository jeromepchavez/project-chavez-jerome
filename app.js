!(function (d) {
    ...
    function setEventListeners() {
        var next = d.getElementsByClassName('slideshow__button--next')[0],
            prev = d.getElementsByClassName('slideshow__button--prev')[0];
    ...
    /*window.addEventListener("load", function () {
        setInterval(function () { moveSlideshowTo(slide + 1) }, 4000)
    })
    */
    initSlideshow();
}(document));